...
projection.save('weight', 'after_pro_weights.txt')
projection.save('delay', 'after_pro_delays.txt')
projection.save(['weight', 'delay'], 'after_pro_weights_delays.txt')
projection.save('connections', 'after_pro_connections.txt')
projection.save('all', 'after_pro_all.txt')
