...
void neuron_model_print_parameters(restrict neuron_pointer_t neuron) {
    ...
    log_debug("my_parameter = %11.4k mv", neuron->my_parameter);
    log_debug("V_rest = %11.4k mv", neuron->V_rest);
    log_debug("decay = %11.4k mv", neuron->decay);
}
