...
class _DUAL_EXP_TYPES(Enum):
    ...
    MULTIPLICATOR = (10, DataType.S1615)
...
class SynapseTypeSEMD(AbstractSynapseType, AbstractContainsUnits):

    def __init__(self, n_neurons, tau_syn_E, tau_syn_E2,
                 tau_syn_I, initial_input_exc, initial_input_exc2,
                 initial_input_inh, multiplicator):
    ...
    def get_synapse_type_parameters(self, machine_time_step):
        ...
        return [
            NeuronParameter(self._multiplicator, _DUAL_EXP_TYPES.MULTIPLICATOR.data_type),
