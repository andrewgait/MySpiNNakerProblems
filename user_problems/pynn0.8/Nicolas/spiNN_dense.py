...
connections_1 = read_connections(p1)
connections_2 = read_connections(p2)
...
#connector_1 = sim.FromListConnector(connections_2, column_names=["i", "j", "weight", "delay"])
...
#connector_2 = sim.FromListConnector(connections_2, column_names=["i", "j", "weight", "delay"])
