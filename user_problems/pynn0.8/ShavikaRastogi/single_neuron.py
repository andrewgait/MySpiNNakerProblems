...
neuron=sim.Population(1,izk(**neuron_params_RS))

'''
# Building network

n_nex=sim.Projection(neuron,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=0.15,delay=delay),receptor_type='excitatory')
n_nin=sim.Projection(neuron,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=-0.15,delay=delay),receptor_type='inhibitory')
'''
...
on_path_ex=sim.Projection(on_input_ex,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=0.15,delay=delay),receptor_type='excitatory')
on_path_in=sim.Projection(on_input_in,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=-0.15,delay=delay),receptor_type='inhibitory')
off_path_ex=sim.Projection(off_input_ex,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=0.15,delay=delay),receptor_type='excitatory')
off_path_in=sim.Projection(off_input_in,neuron,sim.FixedProbabilityConnector(0.5,rng=rng),synapse_type=sim.StaticSynapse(weight=-0.15,delay=delay),receptor_type='inhibitory')
...
np.save('spin3_results/noisy_wave_rs_population5050_snr2_dt0_2/mp_rs_population5050_purewavef1_dt_0_2_v5',v)
...
plt.savefig('spin3_results/noisy_wave_rs_population5050_snr2_dt0_2/spikes_rs_population5050_purewavef1_dt_0_2_v5.png')


Figure(Panel(v,ylabel='Membrane Potential (mV)',xticks=True,xlabel='Time (ms)',yticks=True), settings={'savefig.dpi':300}).save('spin3_results/noisy_wave_rs_population5050_snr2_dt0_2/v_rs_population5050_purewavef1_dt_0_2_v5.png')
...
with open('spin3_results/noisy_wave_rs_population5050_snr2_dt0_2/results_rs_population5050_purewavef1_dt_0_2_v5.pickle','wb') as f:
