...
fsi_pop1 = p.Population(numCellsPerCol_FSI, p.extra_models.Izhikevich_cond_dual, fsi_cell_params, label='fsi_pop1' )# ,additional_parameters={"splitter": SplitterAbstractPopulationVertexNeuronsSynapses(1)})
