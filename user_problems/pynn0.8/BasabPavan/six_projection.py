...
stdp_cort2strd2_AMPA = p.STDPMechanism(
        timing_dependence=p.SpikePairRule(
            tau_plus=1, tau_minus=0.5,
            A_plus=1, A_minus=0.5),
        weight_dependence=p.AdditiveWeightDependence(
            w_min=0.0140, w_max=1), weight=0.1)

stdp_cort2fsi_AMPA = p.STDPMechanism(
        timing_dependence=p.SpikePairRule(
...
stdp_strd1_snr_AMPA = p.STDPMechanism(
        timing_dependence=p.SpikePairRule(
...
stdp_cort2stn_AMPA = p.STDPMechanism(
        timing_dependence=p.SpikePairRule(
            tau_plus=0.001, tau_minus=1,
            A_plus=0.001, A_minus=1),
        weight_dependence=p.AdditiveWeightDependence(
...
stdp_strd2_pop12gpe_pop1 = p.STDPMechanism(
        timing_dependence=p.SpikePairRule(
            tau_plus=0.25, tau_minus=2,
            A_plus=0.25, A_minus=2),
        weight_dependence=p.AdditiveWeightDependence(
...
projections_cort2_pop1.append(p.Projection(spike_source_Poisson_base1_strd2, strd2_pop1,
            p.FixedProbabilityConnector(p_connect=pconn_cort2str),
            synapse_type=stdp_cort2strd2_AMPA,
...
p.Projection(spike_source_Poisson_base2_strd2, strd2_pop1,
            p.FixedProbabilityConnector(p_connect=pconn_cort2str),
            p.StaticSynapse(weight=g_cort2strd2/16, delay=distr_strd2),
            receptor_type ='excitatory2')


projections_cort2_pop1.append(p.Projection(spike_source_Poisson_base1_strfsi, fsi_pop1,
            p.FixedProbabilityConnector(p_connect=pconn_cort2str),
            synapse_type=stdp_cort2fsi_AMPA,
...
projections_cort2_pop1.append(p.Projection(spike_source_Poisson_base1_stn, stn_pop1,
            p.FixedProbabilityConnector(p_connect=pconn_cort2str),
#                      synapse_type=stdp_cort[count1],
            synapse_type=stdp_cort2stn_AMPA,
...
snc_2_strd2_pop_projection=p.Projection(
        snc_pop1, strd2_pop1,  p.AllToAllConnector(),
        synapse_type=p.extra_models.Neuromodulation(
...
snc_2_strfsi_pop_projection=p.Projection(
...
snc_2_str2stn_pop_projection=p.Projection(
...
max_w_gpe=1
DA_concentration_reward_gpe=0.005
snc_2_str2stn_pop_projection=p.Projection(
...
projections_cort2_strd2_w_transpose=np.transpose(projections_cort2_strd2_w)
projections_cort2_strdfsi_w_transpose=np.transpose(projections_cort2_strdfsi_w)
...
# '''This code is for seeing weights which are 0.0'''
# count_zero_weight_strd2=0
# for i in range(0,len(projections_cort2_strd2_w_transpose[2])):
#     for j in range(0,len(projections_cort2_strd2_w_transpose[2][i])):
#         if(projections_cort2_strd2_w_transpose[2][i][j]==0.0 ):
#             #print(projections_cort2_strd2_w_transpose[2][i][j])
#             count_zero_weight_strd2=count_zero_weight_strd2+1
# print("count_zero_weight_strd2",count_zero_weight_strd2)
...
# '''This code is for seeing weights which are 0.0'''
# count_non_zero_weight_strd2=0
# for i in range(0,len(projections_cort2_strd2_w_transpose[2])):
#     for j in range(0,len(projections_cort2_strd2_w_transpose[2][i])):
#         if(projections_cort2_strd2_w_transpose[2][i][j]!=0.0 ):
#             #print(projections_cort2_strd2_w_transpose[2][i][j])
#             count_non_zero_weight_strd2=count_non_zero_weight_strd2+1
# print("count_non_zero_weight_strd2",count_non_zero_weight_strd2)
...
# '''This code is for seeing weights which are 0.0'''
# count_non_zero_weight_strdfsi=0
# for i in range(0,len(projections_cort2_strdfsi_w_transpose[2])):
#     for j in range(0,len(projections_cort2_strdfsi_w_transpose[2][i])):
#         if(projections_cort2_strdfsi_w_transpose[2][i][j]!=0.0 ):
#             #print(projections_cort2_strd2_w_transpose[2][i][j])
#             count_non_zero_weight_strdfsi=count_non_zero_weight_strdfsi+1
# print("count_non_zero_weight_strdfsi",count_non_zero_weight_strdfsi)


# In[ ]:


# count_zero_weight_strdfsi=0
# for i in range(0,len(projections_cort2_strdfsi_w_transpose[2])):
#     for j in range(0,len(projections_cort2_strdfsi_w_transpose[2][i])):
#         if(projections_cort2_strdfsi_w_transpose[2][i][j]==0.0 ):
#             #print(projections_cort2_strd2_w_transpose[2][i][j])
#             count_zero_weight_strdfsi=count_zero_weight_strdfsi+1
# print("count_zero_weight_strdfsi",count_zero_weight_strdfsi)
...
#PLOTTING WEIGHTS PROGRESSION FROM CORTICAL TO STRD2
projections_cort2_strd2_w_transpose=np.transpose(projections_cort2_strd2_w)
plt.figure()
plt.xlabel('Time(s)',fontsize=22)
plt.ylabel('Weights',fontsize=22)
# plt.xticks(fontsize=22)
plt.yticks(fontsize=22)
plt.plot(np.transpose(projections_cort2_strd2_w_transpose[2]))
plt.show()
...
#PLOTTING WEIGHTS PROGRESSION FROM CORTICAL TO STRDfsi
projections_cort2_strdfsi_w_transpose=np.transpose(projections_cort2_strdfsi_w)
plt.figure()
plt.xlabel('Time(s)',fontsize=22)
plt.ylabel('Weights',fontsize=22)
# plt.xticks(fontsize=22)
plt.yticks(fontsize=22)
plt.plot(np.transpose(projections_cort2_strdfsi_w_transpose[2]))
plt.show()
...
#PLOTTING WEIGHTS PROGRESSION FROM CORTICAL TO STN
projections_cort2_stn_w_transpose=np.transpose(projections_cort2_stn_w)
plt.figure()
plt.xlabel('Time(s)',fontsize=22)
plt.ylabel('Weights',fontsize=22)
# plt.xticks(fontsize=22)
plt.yticks(fontsize=22)
plt.plot(np.transpose(projections_cort2_stn_w_transpose[2]))
plt.show()
...
#PLOTTING WEIGHTS PROGRESSION FROM STRD1 TO SNr
projection_strd1_snr_w_transpose=np.transpose(projection_strd1_snr_w)
plt.figure()
plt.xlabel('Time(s)',fontsize=22)
plt.ylabel('Weights',fontsize=22)
# plt.xticks(fontsize=22)
plt.yticks(fontsize=22)
plt.plot(np.transpose(projection_strd1_snr_w_transpose[2]))
plt.show()
...
#PLOTTING WEIGHTS PROGRESSION FROM CORTICAL TO STRD1
projection_strd2_gpe_w_transpose=np.transpose(projection_strd2_gpe_w)
plt.figure()
plt.xlabel('Time(s)',fontsize=22)
plt.ylabel('Weights',fontsize=22)
# plt.xticks(fontsize=22)
plt.yticks(fontsize=22)
plt.plot(np.transpose(np.array(projection_strd2_gpe_w_transpose[2])))
plt.show()
