...
''' THE FIRST CHANNEL'''
strd1_pop1 = p.Population(numCellsPerCol_STR, p.extra_models.Izhikevich_cond, strd1_cell_params,
                          label='strd1_pop1') #, additional_parameters={"splitter": SplitterAbstractPopulationVertexNeuronsSynapses(1)})
strd2_pop1 = p.Population(numCellsPerCol_STR, p.extra_models.Izhikevich_cond, strd2_cell_params,
                          label='strd2_pop1') #,additional_parameters={"splitter": SplitterAbstractPopulationVertexNeuronsSynapses(1)})
fsi_pop1 = p.Population(numCellsPerCol_FSI, p.extra_models.Izhikevich_cond, fsi_cell_params, label='fsi_pop1') #,
