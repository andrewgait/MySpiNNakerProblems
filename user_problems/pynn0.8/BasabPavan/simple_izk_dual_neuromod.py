...
sim.setup(timestep=0.1, time_scale_factor=10)
# sim.setup(timestep=1.0)
sim.set_number_of_neurons_per_core(sim.extra_models.Izhikevich_cond, 8)
sim.set_number_of_neurons_per_core(sim.extra_models.Izhikevich_cond_dual, 8)

numCellsPerCol_STR = 16
# numCellsPerCol_GPe = 20
# numCellsPerCol_SNC = 10
numPoissonInput_str = 8
...
strd1_pop1.record(['spikes','v','gsyn_exc'])
